...
@Entity
@Table(name = "uk_agentservice_stats_day")
@org.hibernate.annotations.Proxy(lazy = false)
public class AgentServiceStatsDay implements java.io.Serializable{
	...
	public int getLeavemsgcount() {return leavemsgcount;}
	public void setLeavemsgcount(int leavemsgcount) {this.leavemsgcount = leavemsgcount;}
